...
using FinTrakERP.Auditing.Exporting;
using FinTrakERP.Authorization;
using FinTrakERP.Authorization.Users;
using FinTrakERP.Dto;
using FinTrakERP.EntityHistory;
using EntityHistoryHelper = FinTrakERP.EntityHistory.EntityHistoryHelper;

namespace FinTrakERP.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : FinTrakERPAppServiceBase, IAuditLogAppService
    {
