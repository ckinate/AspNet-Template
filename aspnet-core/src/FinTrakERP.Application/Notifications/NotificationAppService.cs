...
using Abp.UI;
using FinTrakERP.Notifications.Dto;

namespace FinTrakERP.Notifications
{
    [AbpAuthorize]
    public class NotificationAppService : FinTrakERPAppServiceBase, INotificationAppService
    {
