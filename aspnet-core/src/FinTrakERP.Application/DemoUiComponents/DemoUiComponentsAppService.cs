...
using FinTrakERP.DemoUiComponents.Dto;

namespace FinTrakERP.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : FinTrakERPAppServiceBase, IDemoUiComponentsAppService
    {
