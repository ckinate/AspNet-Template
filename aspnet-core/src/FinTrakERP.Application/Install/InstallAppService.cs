...
using FinTrakERP.Migrations.Seed.Host;
...
namespace FinTrakERP.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : FinTrakERPAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<FinTrakERPDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{FinTrakERPConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{FinTrakERPConsts.ConnectionStringName}", constring);
        }
