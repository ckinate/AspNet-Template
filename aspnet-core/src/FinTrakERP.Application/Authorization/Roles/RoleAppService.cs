...
using FinTrakERP.Authorization.Permissions;
using FinTrakERP.Authorization.Permissions.Dto;
using FinTrakERP.Authorization.Roles.Dto;

namespace FinTrakERP.Authorization.Roles
{
    /// <summary>
    /// Application service that is used by 'role management' page.
    /// </summary>
    [AbpAuthorize(AppPermissions.Pages_Administration_Roles)]
    public class RoleAppService : FinTrakERPAppServiceBase, IRoleAppService
    {
