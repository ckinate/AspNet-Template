...
using FinTrakERP.Authorization.Users.Profile.Cache;
using FinTrakERP.Authorization.Users.Profile.Dto;
using FinTrakERP.Configuration;
using FinTrakERP.Friendships;
using FinTrakERP.Gdpr;
using FinTrakERP.Net.Sms;
using FinTrakERP.Security;
using FinTrakERP.Storage;
using FinTrakERP.Timing;

namespace FinTrakERP.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : FinTrakERPAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("FinTrakERP",
