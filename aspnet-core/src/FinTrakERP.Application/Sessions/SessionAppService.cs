...
{
    public class SessionAppService : FinTrakERPAppServiceBase, ISessionAppService
    {
        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    Currency = FinTrakERPConsts.Currency,
                    CurrencySign = FinTrakERPConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = FinTrakERPConsts.AllowTenantsToChangeEmailSettings,
