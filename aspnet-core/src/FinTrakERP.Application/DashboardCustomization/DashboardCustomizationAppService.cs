...
using FinTrakERP.DashboardCustomization.Dto;
using Newtonsoft.Json;

namespace FinTrakERP.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : FinTrakERPAppServiceBase, IDashboardCustomizationAppService
    {
