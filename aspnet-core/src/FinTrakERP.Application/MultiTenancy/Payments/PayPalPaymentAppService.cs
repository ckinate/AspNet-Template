...
using FinTrakERP.MultiTenancy.Payments.Paypal;
using FinTrakERP.MultiTenancy.Payments.PayPal;
using FinTrakERP.MultiTenancy.Payments.PayPal.Dto;

namespace FinTrakERP.MultiTenancy.Payments
{
    public class PayPalPaymentAppService : FinTrakERPAppServiceBase, IPayPalPaymentAppService
    {
