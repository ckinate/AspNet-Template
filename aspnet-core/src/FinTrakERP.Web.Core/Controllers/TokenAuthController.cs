...
using FinTrakERP.Authentication.TwoFactor.Google;
using FinTrakERP.Authorization;
using FinTrakERP.Authorization.Accounts.Dto;
...
namespace FinTrakERP.Web.Controllers
{
    ...
    public class TokenAuthController : FinTrakERPControllerBase
    {
