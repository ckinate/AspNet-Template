...
using FinTrakERP.Web.Authentication.JwtBearer;
using FinTrakERP.Web.Authentication.TwoFactor;
using FinTrakERP.Web.Chat.SignalR;
using FinTrakERP.Web.Configuration;
using FinTrakERP.Web.DashboardCustomization;

namespace FinTrakERP.Web
{
    [DependsOn(
        typeof(FinTrakERPApplicationModule),
        typeof(FinTrakERPEntityFrameworkCoreModule),
    ...
    public class FinTrakERPWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public FinTrakERPWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(FinTrakERPApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(FinTrakERPWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(FinTrakERPWebCoreModule).Assembly);
        }
