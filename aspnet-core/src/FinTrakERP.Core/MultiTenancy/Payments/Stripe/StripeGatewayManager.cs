...
{
    public class StripeGatewayManager : FinTrakERPServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "FinTrakERP";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + FinTrakERPConsts.Currency;
        }
