...
using FinTrakERP.MultiTenancy.Demo;
...
namespace FinTrakERP.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
            ...
            string emailActivationLink)
        {
            ...
            {
                throw new UserFriendlyException(LocalizationManager.GetString(FinTrakERPConsts.LocalizationSourceName, "TrialWithoutEndDateErrorMessage"));
            }
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            ...
            var error = LocalizationManager.GetSource(FinTrakERPConsts.LocalizationSourceName).GetString("FreeEditionsCannotHaveTrialVersions");
