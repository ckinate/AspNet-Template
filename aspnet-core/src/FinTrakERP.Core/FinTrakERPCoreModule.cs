...
using FinTrakERP.Authorization.Delegation;
using FinTrakERP.Authorization.Ldap;
...
using FinTrakERP.DashboardCustomization.Definitions;
using FinTrakERP.Debugging;
using FinTrakERP.DynamicEntityProperties;
using FinTrakERP.Features;
using FinTrakERP.Friendships;
using FinTrakERP.Friendships.Cache;
using FinTrakERP.Localization;
using FinTrakERP.MultiTenancy;
using FinTrakERP.Net.Emailing;
using FinTrakERP.Notifications;
using FinTrakERP.WebHooks;

namespace FinTrakERP
{
    [DependsOn(
        typeof(FinTrakERPCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class FinTrakERPCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            FinTrakERPLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = FinTrakERPConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, FinTrakERPMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<FinTrakERPSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(FinTrakERPCoreModule).GetAssembly());
        }
