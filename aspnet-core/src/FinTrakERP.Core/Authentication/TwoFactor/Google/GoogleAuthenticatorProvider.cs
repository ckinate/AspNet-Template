...
namespace FinTrakERP.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : FinTrakERPServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("FinTrakERP", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
