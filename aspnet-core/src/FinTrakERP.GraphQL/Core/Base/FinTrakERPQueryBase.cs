...
namespace FinTrakERP.Core.Base
{
    public abstract class FinTrakERPQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected FinTrakERPQueryBase(string fieldName,
