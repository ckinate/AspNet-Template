...
using FinTrakERP.Web.Startup.ExternalLoginInfoProviders;
...
namespace FinTrakERP.Web.Startup
{
    ...
    public class FinTrakERPWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public FinTrakERPWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(FinTrakERPWebHostModule).GetAssembly());
        }
