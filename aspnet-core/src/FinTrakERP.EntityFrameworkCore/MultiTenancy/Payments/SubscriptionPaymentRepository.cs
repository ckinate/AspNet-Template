...
{
    public class SubscriptionPaymentRepository : FinTrakERPRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<FinTrakERPDbContext> dbContextProvider)
