...
using FinTrakERP.EntityFrameworkCore.Repositories;

namespace FinTrakERP.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : FinTrakERPRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<FinTrakERPDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
