...
using FinTrakERP.Commands;
using FinTrakERP.Core.Threading;
using FinTrakERP.Models.NavigationMenu;
using FinTrakERP.Services.Navigation;
using FinTrakERP.ViewModels.Base;
using Plugin.Media;
...
using FinTrakERP.ApiClient;
using FinTrakERP.Controls;
using FinTrakERP.Dto;
using FinTrakERP.Extensions;
using FinTrakERP.Localization;
using FinTrakERP.UI;
using FinTrakERP.UI.Assets;
using FinTrakERP.Views;
using DependencyResolver = FinTrakERP.Core.Dependency.DependencyResolver;

namespace FinTrakERP.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "FinTrakERP";
