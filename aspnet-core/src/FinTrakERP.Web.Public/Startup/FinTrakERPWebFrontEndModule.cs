...
namespace FinTrakERP.Web.Public.Startup
{
    [DependsOn(
        typeof(FinTrakERPWebCoreModule)
    )]
    public class FinTrakERPWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public FinTrakERPWebFrontEndModule(IWebHostEnvironment env, FinTrakERPEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(FinTrakERPWebFrontEndModule).GetAssembly());
        }
    }
}
