...
using FinTrakERP.Web.Public.Startup;
using FinTrakERP.Web.Session;

namespace FinTrakERP.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : FinTrakERPViewComponent
    {
