...
using FinTrakERP.MultiTenancy.HostDashboard;
...
namespace FinTrakERP.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(FinTrakERPDbContext context, SubscriptionPayment subscriptionPayment)
        {
